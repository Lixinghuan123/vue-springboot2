...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children:[
      {
        path: 'land-info',
        component: () => import('@/views/land/land-info'),
        name: 'LandList',
        meta: {
          title: '土地使用信息',
          roles: ['admin','editor'] // or you can only set roles in sub nav
  ...
  },
  {
    path: '/resident',
    component: Layout,
    redirect: '/resident/resident-baseinfo',
    alwaysShow: true,
    name: 'ResidentManage',
    meta: {
      title: '居民信息管理',
    ...
    children:[
      {
        path: 'resident-baseinfo',
        component: () => import('@/views/resident/resident-baseinfo'),
        name: 'ResidentList',
        meta: {
          title: '基本信息管理',
          roles: ['admin','editor'] // or you can only set roles in sub nav
      ...
      // {
      //   path: 'cadre-elect',
      //   component: () => import('@/views/resident/cadre-elect'),
      //   name: 'CadreElect',
      //   meta: {
      //     title: '干部选举',
      //     roles: ['admin','editor'] // or you can only set roles in sub nav
  ...
  },
  {
    ...
    children:[
      {
        path: 'elect',
        component: () => import('@/views/elect/elect'),
        name: 'ElectInfoList',
        meta: {
          title: '选举投票',
          roles: ['admin','editor'] // or you can only set roles in sub nav
  ...
  },
  {
    path: '/personinfo',
    component: Layout,
    redirect: '/personinfo/account-info',
    alwaysShow: true,
    ...
    children:[
      ...
      {
        path: 'account-update',
        component: () => import('@/views/personinfo/account-update'),
        name: 'AccountUpdate',
        meta: {
          title: '更新账号基本信息',
          roles: ['admin','editor'] // or you can only set roles in sub nav
